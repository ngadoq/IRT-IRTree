HEXACO Applicants Analysis
Date: 15th May 2017

Data analysis was organized using ProjectTemplate in R (more details are provided below).

* The main data analysis script is "main-analysis.rmd".
* Bifactor models are estimated in "lavaan-models.rmd", and the results of the bifactor models are analysed in "analysis-lavaan.rmd". Because the bifactors take many hourse to be estimated on a cluster, the main results have been saved. Thus, if you want to explore the models, you can simply examine `analysis-lavaan.rmd`.
* Data manipualtion is stored in the "munge" directory.
* Data is stored in the "data" directory.

Main system requirements:

* R
* RStudio may help and is recommended
* Install the ProjecTemplate package in R from CRAN
* Install the personalityfacets package on github: 

* Several packages on CRAN that are needed and these are listed in "config/global.dcf". However, ProjectTemplate should automatically download and install these if you don't already have them.

I then recommend opening the project in RStudio by clicking on the "hexaco-applicants.Rproj".
Then open "main-analysis.rmd".
Run the first code chunk to load all the data and run preliminary code, then explore the different code chunks.
